...
mkdir /tmp/${USER}/hf_cache/${SLURM_ARRAY_TASK_ID}_pq_cache
mkdir /tmp/${USER}/hf_cache/${SLURM_ARRAY_TASK_ID}_pq_cache/transformer
mkdir /tmp/${USER}/hf_cache/${SLURM_ARRAY_TASK_ID}_pq_cache/hf
conda activate /tudelft.net/staff-umbrella/tunoMSc2023/codes/gpt_env/
export TRANSFORMERS_CACHE=/tmp/${USER}/hf_cache/${SLURM_ARRAY_TASK_ID}_pq_cache/transformer
export HF_HOME=/tmp/${USER}/hf_cache/${SLURM_ARRAY_TASK_ID}_pq_cache/hf
#srun matlab < matlab_script.m # Computations should be started with 'srun'.
python /tudelft.net/staff-umbrella/tunoMSc2023/codes_repo/label_per_question_array_process.py
rm -r /tmp/${USER}/hf_cache/${SLURM_ARRAY_TASK_ID}_pq_cache
