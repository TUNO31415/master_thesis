...
#SBATCH --time=0:10:00      # Request run time (wall-clock). Default is 1 minute
...
mkdir /tmp/${USER}/hf_cache/sm_cache
mkdir /tmp/${USER}/hf_cache/sm_cache/transformer
mkdir /tmp/${USER}/hf_cache/sm_cache/hf
conda activate /tudelft.net/staff-umbrella/tunoMSc2023/codes/gpt_env/
export TRANSFORMERS_CACHE=/tmp/${USER}/hf_cache/sm_cache/transformer
export HF_HOME=/tmp/${USER}/hf_cache/sm_cache/hf
...
rm -r /tmp/${USER}/hf_cache/sm_cache
